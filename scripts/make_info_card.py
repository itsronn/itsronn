...
# ===========================================================================
HOST = "ron"   # shown as  ron@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "B.Tech AI & Data Science, MITS '27"),
    ("kv", "Focus", "AI/ML enthusiast"),
    ("kv", "Projects", "Learning Disability Screening, Expense Tracker"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C/C++, Python, JS, TypeScript, SQL"),
    ("kv", "Frontend", "React.js, Tailwind CSS"),
    ("kv", "Backend", "FastAPI, Node.js, Supabase"),
    ("kv", "AI / ML", "PyTorch, Scikit-Learn, MediaPipe, Gemini API"),
    ("kv", "Cloud", "AWS, Git, Linux"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Top 10 Asia/Oceania - Kaspersky CTF 2025"),
    ("bul", "Winner - Shreshta CTF & MCSC CTF 2025"),
]
